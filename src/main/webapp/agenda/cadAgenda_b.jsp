...
<head>
    <meta charset="UTF-8">
    <title><s:text name="label.agendas"/></title>
    ...
    <div class="container">
        <div class="row mt-5 mb-2">
            <div class="col-sm p-0">
                <h2><s:text name="label.agendas"/></h2>
            </div>
        </div>
        <div class="row">
                        ...
                        <tr>
                            ...
                            <td>
                                <s:if test="periodo == 'MANHA'">
                                    <s:text name="label.manha"/>
                                </s:if>
                                <s:elseif test="periodo == 'TARDE'">
                                    <s:text name="label.tarde"/>
                                </s:elseif>
                                <s:elseif test="periodo == 'AMBOS'">
                                    <s:text name="label.ambos"/>
                                </s:elseif>
                            </td>
                            <td class="text-end">
                                ...
                                <a href="#" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#confirmarExclusao" data-rowid="${rowid}"><s:text name="label.excluir"/></a>
                            </td>
                        </tr>
                    </s:iterator>
                </tbody>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a id="excluir" href="#" class="btn btn-primary" style="width: 75px;"><s:text name="label.sim"/></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        botoesExcluir.forEach(function(botao) {
            botao.onclick = function() {
                ...
                botaoConfirmar.href = 'excluirAgendas.action?agendaVo.rowid=' + rowid;
            };
        });
    </script>
</body>
